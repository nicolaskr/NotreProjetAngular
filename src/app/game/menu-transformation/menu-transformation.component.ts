...
export class MenuTransformationComponent implements OnInit {
  ...
  constructor(private sessionBatimentService: SessionBatimentService, private sessionRessourceService: SessionRessourceService, private transformationRessourceService: TransformationRessourceService) {
  ...
  save() {
    this.sessionRessourceService.transformer(this.sessionActive!, this.choixTransformation, this.quantite).subscribe;
  }
